            ...
            <div className="space-y-2">
              ...
              {hoursType === 'custom' && (
                <input
                  ...
                  inputMode="decimal"
                  placeholder="Örn: 180"
                  className="w-full rounded-lg border border-border bg-background px-4 py-2 text-foreground text-sm font-mono mt-2"
                  value={customHoursStr}
                  onChange={(e) => setCustomHoursStr(sanitizeNumericInput(e.target.value, { allowDecimal: true }))}
                />
              )}
            </div>
